...
%     newTime, newSplineXY = stretch2DCurve(t,f,l,dp,s,o) returns the new time vector
%     created after the stretching process and the points in the new spline curves,
%     in both dimensions of dp. t is the original duration of the trajectory, used to
...
%     See also stretch1DCurve, stretch3DCurve 
